...
public class LightBeams implements SaveFileReader.CustomChunk {
    ...
    /**Find the closest point away from the origin that a colour will fade to 0. Use {@link main.world.systems.light.LightBeams#furthestFalloffPoint} instead if finding furthest point.
     */
